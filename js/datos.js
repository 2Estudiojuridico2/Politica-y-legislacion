...
const UNIDADES = [
    ...
    { id: 7, numero: "07", titulo: "Rol Docente y Educación", desc: "Leyes de Educación y Estatuto Docente (Ley 10.579).", color: "cyan", icon: "fa-chalkboard-teacher" }
];

const LEYES_DB = [
    { 
        eje: 1, 
        titulo: "Constitución Nacional - Art. 75 inc. 23", 
    ...
    { 
        eje: 3, 
        titulo: "Convención Internacional (Ley 26.378)", 
...
const CASOS_DB = [
    {
        eje: 1, 
        tema: "Derecho a la Igualdad y No Discriminación",
    ...
    {
        eje: 3, 
        tema: "Acceso a la Justicia (Ajustes de Procedimiento)",
    ...
    {
        eje: 7, 
        tema: "Cobertura Educativa e Integración",
